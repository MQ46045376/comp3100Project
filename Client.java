...
public class Client {
	...
	public static void initHandshake(BufferedReader in, DataOutputStream out) {
		try {
			...
			if (received.equals("OK")) {
				...
				System.out.println("ERROR: first OK was not received");
			}
			...
			if (received.equals("OK")) {
				...
				System.out.println("ERROR: second OK was not received");
			}
	...
	public static String algSchd(String job[], BufferedReader in, DataOutputStream dout) throws IOException {
		...
		String serverInfo = "";
		serverInfo = updatedServerList[serverCounter - 1].getType() + " "
				+ updatedServerList[serverCounter - 1].getID();
